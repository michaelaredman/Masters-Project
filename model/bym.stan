functions {
  /**
  * This is taken from Max Joseph's write-up here: http://mc-stan.org/documentation/case-studies/mbjoseph-CARStan.html
  *
...
model {
    ...
    for (t in 1:nt){
	observed[,t] ~ poisson_log(log_expected + rep_vector(temporal[t], numRegions) + lmbda);
    }
}
